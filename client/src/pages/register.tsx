...
export default function register() {
  ...
  return (
    <div className="w-screen h-screen py-10 overflow-y-scroll">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className={` ${landForm ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"} duration-1000 fltex transform navShadow outline outline-[#6e6d6d67] rounded-lg max-w-fit items-center flex-col mt-[calc(100vh-95vh)] md:mt-[calc(100vh-90vh)] mx-auto bg-white tm:px-10 px-4 py-5 tm:py-10 `} >
            <div className=" items-center flex flex-col ">
                <h1 className="font-bold tm:text-[30px] text-[25px] text-[#46005c]">Register Now</h1>
            ...
            <div className="flex flex-col gap-y-1 mt-3">
                <label htmlFor="username" className="tm:text-[20px] text-[15px] font-[Arial] ">Username</label>
                <div className=" max-w-fit flex items-center outline outline-[purple] rounded-md">
                    <UserName className="text-[purple] w-6 h-6 ml-2" />
                    <input id="username" type="text" className=" border-none outline-none text-[16] ts:text-[20px] font-[Arial] cursor-pointer w-67 ts:w-90 tm:h-10 h-8 px-2"
                    {...register("username",
                        {
            ...
            { errors.email && <span className="w-full ml-2 text-[red] text-sm">{errors.email.message}</span>}
            <div className="max-w-fit flex flex-col gap-y-1 mt-5">
                ...
                <div className="max-w-fit flex items-center outline outline-[purple] rounded-md">
                    ...
                    />
                    <ShowPassword onClick={() => setPassword(!hideShowPassword)} className=" text-[#000000cb] w-5 h-5 ts:w-7 ts:h-7 hover:bg-[#29292931] duration-300 cursor-pointer mr-1  active:bg-[#29292931] p-1 flex items-center rounded-full" />
                </div>
            </div>
            ...
            <div className="max-w-fit flex flex-col gap-y-1 mt-5">
                ...
                <div className=" max-w-fit flex items-center outline outline-[purple] rounded-md">
                    ...
                    <input id="passwordConform" type="text" className="cursor-pointer w-67 ts:w-90 ts:h-10 h-8 px-2 border-none outline-none text-[16px] ts:text-[20px] font-[Arial]" 
            ...
            <div className="mt-3 cursor-pointer hover:border-[purple] duration-300 flex items-center text-center text-[15px] ts:text-[22px] justify-center gap-x-2 border border-[#1f1f1faa] py-1 ts:py-2 rounded-full w-[calc(100%-10%)] ts:w-[calc(100%-5%)] ">
                continue with
