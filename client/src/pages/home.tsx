    ...
    <>
      <div className="absolute top-0 w-screen h-auto ">
        <div className=" flex overflow-x-hidden w-screen relative h-screen  bg-center bg-cover bg-no-repeat to-[white] from-[purple]" style={{ backgroundImage: "url('./hero.svg')"}} >
          ...
          <div className={`flex w-fit ts:ml-[calc(100vw-90vw)] mx-auto relative flex-col top-[calc(100vh-70vh)] ${isLand ? "translate-y-0 opacity-100" : "translate-y-15 opacity-0"} duration-1500 `}>
          
              <h1 className="leading-tight ts:w-100 px-5 w-80 font-[system-ui] ts:mx-0 max-h-fit duration-300 font-bold text-[35px] ts:text-[45px]">Expense tracking made easy</h1>
              <p className="font-[Arial] text-[22px] px-5  w-85 ts:w-150 mt-5">Tracking your spending, organize your expenses, 
